...
--overlap-annot \
--ref-ld-chr /data/clusterfs/lag/users/gokala/enigma-evol/final_analysis/resources/new_annotations/${fannot}/${annot}.,/data/clusterfs/lag/users/gokala/enigma-evol/final_analysis/resources/baselineLD/baselineLD.  \
