...
HSE_7pcw$Enrichment_p <- read.delim("/data/clusterfs/lag/users/gokala/enigma-evol/final_analysis/results/european/partherit/results_tables/fetal_hge_hg19.merged.sorted_results_FDR.txt", header = T)
...
#               out_prefix = "/data/clusterfs/lag/users/gokala/enigma-evol/final_analysis/results/european/partherit/plots/",
#               out_suffix = "left_",
#               loop_over = "Annotation",
#               region_col = "Region",
#               Z_col = "Enrichment_plot",
