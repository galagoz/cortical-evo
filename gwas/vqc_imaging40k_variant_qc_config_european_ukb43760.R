...
subset_name="ukb43760_enigmaEvo_european"

# Directory containing the SNP statistics files
stats_dir= "/data/clusterfs/lag/users/barmol/enigma_evo/output/subset_european"

# Directory where output is written to
working_dir= "/data/clusterfs/lag/users/barmol/enigma_evo/output/vqc_european/"
